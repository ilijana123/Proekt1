...
function showCategory(category) {
    // Оваа функција се повикува при клик на категоријата
    // Тука можете да направите што и да е соодветно за приказ на содржината за избраната категорија
    console.log(`Showing content for category: ${category}`);
    // Дополнете ја соодветно оваа функција
}